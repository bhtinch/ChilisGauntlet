...
class BenViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let king = KingController.shared.kings[2]
        self.king = king
    ...
    func updateViews(king: King) {
        ...
        imageView.image = UIImage(imageLiteralResourceName: BenConstants.imageString)
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "toBenEditVC" {
...
extension BenViewController: EditKingViewControllerDelegate{
